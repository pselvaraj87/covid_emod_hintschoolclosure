...
python3 change_ser_pop.py stage1_1k_mr_hh_output/state-00000.dtk
#cp stage1_1k_mr_hh_output/state-00000.dtk my_sp_file.dtk
~/EMOD/DtkTrunk-GO/build/x64/Release/Eradication/Eradication -C poi_mods.json -P . -I . -O sim_1k_mr_hh_output
